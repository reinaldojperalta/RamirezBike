<%@ Page Title="" Language="C#" MasterPageFile="~/Vista/admin/dashboard.master" AutoEventWireup="true" CodeBehind="Ventas.aspx.cs" Inherits="AppRamirezBike.Vista.admin.Ventas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentSubPage" runat="server"><div class="d-flex justify-content-between align-items-center mb-4">
...
        <script type="text/javascript">
    ...
    // La URL de la página ahora apunta a Ventas.aspx
    const pageUrl = "Ventas.aspx";
    let tablaVentas;
            ...
            tablaVentas = $('#tablaVentas').DataTable({
                ...
                ajax: {
                    ...
                    error: function (xhr, error, thrown) {
                        ...
                        alert("Error al cargar la tabla de Ventas.");
                    }
                },
                columns: [
                    {
                    ...
                    { data: 'Estado' },
                    {
                        ...
                        render: function (data) {
                            // Formato de fecha simple (asumiendo que viene como string de fecha C#)
